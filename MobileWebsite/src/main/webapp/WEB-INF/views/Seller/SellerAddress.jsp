...
<div>
	<jsp:include page="../Common/navbar.jsp" flush="true" />
 	<div class="sidebar ">
	    ...
	    <a class="active" href="<spring:url value='/sellerAddress' />">Address</a>
    ...
    <div class="right_bar inside_div">
    	...
    	<div id="id01" class="modall " style="display:none; position:relative; top:-100px;">
    		...
    		<form class="modal-content animate " action="<spring:url value='/sellerAddress' />" method="post">
            	<div class="container">
    ...
    <theader>
           ...
           <%List<SellerAddress> add = (List<SellerAddress>) session.getAttribute("Seller_addr");
for (SellerAddress a : add) {%>
            <tr>
                <td><%=a.getFullName()%></td>
                <td><%=a.getMobile()%></td>
                <td><%=a.getPinCode()%></td>
