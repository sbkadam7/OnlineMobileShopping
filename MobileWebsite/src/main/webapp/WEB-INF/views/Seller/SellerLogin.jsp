...
<div class="login_signup">
    ...
    <div id="id01" class="modal" style="display: none;"> 
        <form class="modal-content animate" action="<spring:url value='/sellerlogin'/>" method="post">
            <!-- website logo !-->
           <!-- <div class="imgcontainer">
            ...
            <div class="container" style="background-color:#f1f1f1">
                <button type="button" onclick="document.getElementById('id01').style.display='none'"
                  ...
                  <!-- <button class ="signup"  onclick="location.href='<spring:url value='/sellerSignup'/>'>Signup</button>  -->
                   <%--  <button class ="signup"><a href ="<spring:url value='/sellerSignup'/>">Signup</a></button>  --%> 
 ...
 <div id="id02" class="modal" > 
        <form class="modal-content animate" action="<spring:url value='/sellerSignup'/>" method="post">
            <div class="container">
                ...
                <label for="companyname"><b>Compnay/Business name</b></label>
                <input type="text" placeholder="Enter the company/business name as registered in GST/PAN"
                    name="shopName" required>

                <label for="PAN"><b>Pan Card Number</b></label>
                <input type="text" placeholder="Enter PAN card number" name="panCard" required>

                <label for="GST"><b>GST number</b></label>
