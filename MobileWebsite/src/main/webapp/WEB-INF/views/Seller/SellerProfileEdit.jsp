    ...
    <link rel="stylesheet" href="css/styles_elements.css">
        ...
        <div>
            <div class="sidebar">
                ...
                <a href="<spring:url value='/orderHistory' />">Orders</a>
            </div>
            ...
            %>
                    ...
                    <div>
                        ...
                        <div class="pos">
                            <form class="modal-contentt animatee " action="<spring:url value='/sellerUpdate'/>" method="post">
                                <div class="container">
                                    <table>
                                        <tr>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input type="number" value="<%=s.getMobileNo() %>" name="mobileNo" readonly disabled><br>

                                            </td>

                                            <td>
                                                <label for="companyname"><b>Compnay/Business name</b></label><br>
                                                <input type="text" value="<%=s.getShopName() %>" name="shopName" required disabled><br>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input type="text" value="<%=s.getPanCard() %>" name="panCard" required disabled><br>

                                            </td>

                                            <td>
                                                <label for="GST"><b>GST number</b></label><br>
                                                <input type="text" value="<%=s.getGst() %>" name="gst" required disabled><br>
                                            </td>
